...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("main","it started");
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_main);
        Log.d("main","pulse check");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        alertDialogBuilder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                confirmDialogBuilder.setMessage("Are you sure you want to delete?");
                confirmDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainActivity.this,"Item "+idf.getText().toString()+" deleted succefully!"  , Toast.LENGTH_SHORT  ).show();
